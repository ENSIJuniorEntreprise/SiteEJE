...
function FirstHighLight({ cover, publishedAt, title, shortDescription }) {
  return (
    <div className="h-auto w-[100%] flex flex-col-reverse bg-[#E0DED2] md:rounded-bl-[150px] bl:rounded-tr-[250px] overflow-hidden justify-center items-center lg:flex-row lg:h-[60vh] xl:h-[70vh] 2xl:h-[80vh] ">
      {/* Partie gauche (texte) */}
      <div className="flex flex-col w-full px-[10%] pb-[10%] bg-[#E0DED3]  lg:justify-start lg:items-start lg:w-[50%] lg:p-[5%] justify-center items-center font-montserrat">
        ...
        <br />
        <p className="description text-[#1F2029]  sm:text-xl md:text-2xl lg:text-xl xl:text-2xl 2xl:text-3xl font-montserrat line-clamp-3">
          {shortDescription}
        </p>
        <br />
        <button className="relative overflow-hidden bg-transparent text-center text-[#1F2029] font-bold text-lg lg:text-xl transition duration-300 z-10 py-2 px-4 border-2 border-[#1f20297e] hover:text-black hover:bg-[#2eaded] hover:text-beige font-proxima-nova-bold ">
          Learn more
