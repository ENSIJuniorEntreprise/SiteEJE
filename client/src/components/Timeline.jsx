...
const Timeline = () => {
  return (
    ...
    <section className='flex flex-col h-fit bg-beige rounded-tr-[340] md:flex-row'>
      <div className='bg-light-blue flex flex-col gap-8 pr-20 pl-20 w-[40%]'>
        <h1 className='text-dark-blue flex flex-col gap-4 text-5xl font-Montserrat font-bold mt-56'><span className='text-beige'>Our </span>Achievements</h1>
