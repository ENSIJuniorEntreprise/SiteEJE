...
function Navbar() {
  return (
    // <nav className="bg-gradient-to-r from-[rgba(48,117,154)1%] to-[rgba(31,41,55,1)80%] ">
    <nav style={{ backgroundColor: 'rgba(31, 32, 41, 0.4)', zIndex: '500', position: 'fixed', width: '100%' }} className="dark-blue-gradient">
